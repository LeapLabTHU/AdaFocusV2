...
ROOT_DATASET = 'PATH_TO_DATASET'  # '/data/jilin/'


def return_ucf101(modality):
    filename_categories = 'nzl/ucf101/annotations/classInd.txt'
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'nzl/ucf101/rawframes'
        filename_imglist_train = 'nzl/ucf101/file_list/ucf101_train_split_1_rawframes.txt'
        filename_imglist_val = 'nzl/ucf101/file_list/ucf101_val_split_1_rawframes.txt'
        prefix = 'img_{:05d}.jpg'
    # elif modality == 'Flow':
...
def return_somethingv2(modality):
    ...
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'something-something-v2/20bn-something-something-v2-frames'
        ...
        root_data = ROOT_DATASET + 'something-something-v2/20bn-something-something-v2-flow'
